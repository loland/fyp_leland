...
package com.example.mymap.tracking;
...
import com.example.mymap.tflite.Classifier.Recognition;

/** A tracker that handles non-max suppression and matches existing objects to new detections. */
public class MultiBoxTracker {
  private static final float TEXT_SIZE_DIP = 25; // increase text size
  ...
  public MultiBoxTracker(final Context context, int[] colors) {
  ...
  public synchronized void drawDebug(final Canvas canvas) {
    Log.d("MultiBoxTracker/drawDebug", "drawDebug called");
