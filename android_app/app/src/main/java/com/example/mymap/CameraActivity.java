...
//        CompoundButton.OnCheckedChangeListener,
  ...
  public boolean useCamera2API = true;
  ...
  public ImageView plusImageView, minusImageView;
  ...
  public boolean sendRetrainingImages;
  ...
  protected void onCreate(final Bundle savedInstanceState) {
    ...
    sendRetrainingImages = sharedPref.getBoolean("sendRetrainingImages", true);
    ...
    ArrayAdapter<String> deviceAdapter = new ArrayAdapter<>(CameraActivity.this , R.layout.deviceview_row, R.id.deviceview_row_text, deviceStrings);
...
//    modelStrings = list of .tflite file strings
...
// loops through assets directory to retrieve .tflite files
  ...
  public void onPreviewFrame(final byte[] bytes, final Camera camera) {
    ...
    try {
      ...
      if (rgbBytes == null) {
        ...
        BorderedText.previewWidth = previewWidth;
  ...
  public String chooseCamera() {
    ...
    try {
      for (final String cameraId : manager.getCameraIdList()) {
        ...
        useCamera2API =
            (facing == CameraCharacteristics.LENS_FACING_EXTERNAL) || isHardwareLevelSupported(characteristics, CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_FULL);
