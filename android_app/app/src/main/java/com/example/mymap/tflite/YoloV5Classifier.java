...
public class YoloV5Classifier implements Classifier {
    ...
    public static YoloV5Classifier create(AssetManager assetManager, String modelFilename, String labelFilename, boolean isQuantized, int inputSize, String detectorName, Context context) throws IOException {
        final YoloV5Classifier d = new YoloV5Classifier(detectorName);
        Log.d("YoloV5Classifier/create", "labelFilename: " + labelFilename);
        ...
        try {
            ...
            d.tfliteModel = Utils.loadModelFile(assetManager, context, modelFilename);
...
//    private int[] ANCHORS;
    ...
    private YoloV5Classifier(String detectorName) {
